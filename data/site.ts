...
export const company = {
  ...
  phone: "+91 95978 95084, +91 63856 92143",
...
export const featuredProjects = [
  {
    title: "Global Sales Intelligence Platform",
    description: "Designed a data-led sales operating system that improved visibility, pipeline intelligence, and regional team coordination for a growth-focused business.",
    tech: ["AI", "Analytics", "CRM"],
    demoUrl: "/contact",
  },
  {
    title: "Customer Experience Digital Hub",
    description: "Built a customer-facing digital experience that simplified engagement, increased conversion moments, and created a stronger brand journey across channels.",
    tech: ["UX", "Commerce", "Automation"],
    demoUrl: "/contact",
  },
  {
    title: "Healthcare Workflow Intelligence",
    description: "Developed a workflow-driven operational platform that improved scheduling, reporting, and process visibility across critical healthcare functions.",
    tech: ["Healthcare", "Workflow", "Platform"],
    demoUrl: "/contact",
  },
  {
    title: "Sustainability Engagement Portal",
    description: "Created a digital engagement platform to streamline stakeholder participation, awareness campaigns, and impact reporting for sustainability initiatives.",
    tech: ["Web", "Impact", "Engagement"],
    demoUrl: "/contact",
  },
  {
    title: "AI Support Automation Suite",
    description: "Built an AI-powered support system that reduced manual effort, improved response consistency, and accelerated internal team productivity.",
    tech: ["AI", "Support", "Automation"],
    demoUrl: "/contact",
  },
  {
    title: "Operations Control Center",
    description: "Architected an executive visibility layer that connected planning, reporting, and operational performance into one accessible dashboard.",
    tech: ["ERP", "Operations", "Strategy"],
    demoUrl: "/contact",
  },
  {
    title: "Regional Growth Dashboard",
    description: "Developed a market performance dashboard that helped teams track opportunities, compare signals, and make faster decisions across regions.",
    tech: ["Analytics", "Performance", "Growth"],
    demoUrl: "/contact",
  },
];
  ...
  team: [
    {
      ...
      highlight: "Highest executive authority",
